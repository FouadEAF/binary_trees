 ...
 * or not it has to be the same quantity of levels in left as right,
...
/**
 * binary_tree_is_heap - checks if that a b tree is a valid Max Binary Heap
 * @tree: tree to check
 * Return: 1 it is or 0 if not
 */
